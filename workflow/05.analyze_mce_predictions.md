...
![](05.analyze_mce_predictions_files/figure-gfm/global.comparison.ap-1.png)<!-- -->
...
![](05.analyze_mce_predictions_files/figure-gfm/panel.comparison-1.png)<!-- -->
...
```
    ...
    ##  [4] RcppAnnoy_0.0.21    compiler_4.3.1      systemfonts_1.0.4  
    ##  [7] vctrs_0.6.5         lhs_1.1.6           tune_1.1.1         
    ...
    ## [19] prodlim_2023.03.31  tzdb_0.4.0          ragg_1.2.5         
    ## [22] bit_4.0.5           xfun_0.40           recipes_1.0.6      
    ## [25] highr_0.10          later_1.3.1         broom_1.0.5        
    ## [28] irlba_2.3.5.1       parallel_4.3.1      R6_2.5.1           
    ## [31] rsample_1.1.1       stringi_1.7.12      car_3.1-2          
    ## [34] parallelly_1.36.0   rpart_4.1.19        cellranger_1.1.0   
    ## [37] Rcpp_1.0.13         dials_1.2.0         iterators_1.0.14   
    ## [40] knitr_1.43          future.apply_1.11.0 httpuv_1.6.11      
    ## [43] splines_4.3.1       nnet_7.3-19         timechange_0.2.0   
    ## [46] tidyselect_1.2.0    abind_1.4-5         rstudioapi_0.15.0  
    ## [49] yaml_2.3.7          timeDate_4022.108   codetools_0.2-19   
    ## [52] miniUI_0.1.1.1      listenv_0.9.0       lattice_0.21-8     
    ## [55] shiny_1.7.4         withr_2.5.2         evaluate_0.21      
    ## [58] future_1.33.0       survival_3.5-5      pillar_1.9.0       
    ## [61] carData_3.0-5       foreach_1.5.2       generics_0.1.3     
    ## [64] vroom_1.6.3         hms_1.1.3           munsell_0.5.0      
    ## [67] scales_1.3.0        globals_0.16.2      xtable_1.8-4       
    ## [70] class_7.3-22        glue_1.7.0          tools_4.3.1        
    ## [73] data.table_1.14.8   ggsignif_0.6.4      gower_1.0.1        
    ## [76] cowplot_1.1.1       yardstick_1.2.0     ipred_0.9-14       
    ## [79] colorspace_2.1-0    cli_3.6.3           DiceDesign_1.9     
    ## [82] latex2exp_0.9.6     textshaping_0.3.6   workflows_1.1.3    
    ## [85] parsnip_1.1.0       fansi_1.0.6         lava_1.7.2.1       
    ## [88] gtable_0.3.4        rstatix_0.7.2       GPfit_1.0-8        
    ## [91] digest_0.6.33       farver_2.1.1        htmltools_0.5.6    
    ## [94] lifecycle_1.0.4     hardhat_1.3.0       mime_0.12          
    ## [97] ggExtra_0.10.0      bit64_4.0.5         MASS_7.3-60
